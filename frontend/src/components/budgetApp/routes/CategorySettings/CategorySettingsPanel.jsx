...
function CategoryRow({ name, style, onSave }) {
   ...
   return (
      <tr>
         ...
         <td>
            <button type="button" className="btn btn-sm btn-primary" onClick={() => onSave({ color, icon })}>
               Salva
            </button>
         </td>
      </tr>
      ...
      <>
         <div className="card mb-4">
            <div className="card-body">
               <h5 className="card-title">Entrate — icona e colore</h5>
               <p className="text-muted small">Salvate in questo browser (localStorage).</p>
         ...
         <div className="card mb-0">
            <div className="card-body">
               <h5 className="card-title">Uscite — icona e colore</h5>
               <div className="table-responsive">
                  <table className="table table-sm align-middle">
                     <thead>
                        <tr>
